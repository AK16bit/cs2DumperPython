...
from utils import timeUseInfo, int2hex, errorButDontCloseWindow
...
def dumpConvar():
    ...
    debug("Convars Base Address: %s (Convars Count: %s)" % (
    ...
    debug("Convar Dump Success Percent: %.1f%% (%s / %s) " % (
